...
void dsp_auto_thread0(chanend_t* c_source, chanend_t* c_dest, module_instance_t** modules) {
	...
	SELECT_RES(
		...
		noise_suppressor_expander_control(modules[12]->state, &modules[12]->control);
...
adsp_pipeline_t * adsp_auto_pipeline_init() {
	...
	static pipeline_config_t config0 = { .checksum = {56, 198, 220, 221, 57, 203, 111, 149, 212, 110, 72, 229, 92, 73, 128, 242} };
	...
	static switch_config_t config10 = { .position = 0 };
            ...
            static uint8_t memory11[FORK_STAGE_REQUIRED_MEMORY];
	...
	static noise_suppressor_expander_config_t config12 = { .attack_alpha = 18673771, .release_alpha = 778074, .threshold = 2386766, .slope = -2.0 };

            static noise_suppressor_expander_state_t state12;
            static uint8_t memory12[NOISE_SUPPRESSOR_EXPANDER_STAGE_REQUIRED_MEMORY(1)];
            ...
            adsp_auto.modules[12].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[12].control.module_type = e_dsp_stage_noise_suppressor_expander;
                adsp_auto.modules[12].control.num_control_commands = NUM_CMDS_NOISE_SUPPRESSOR_EXPANDER;
                noise_suppressor_expander_init(&adsp_auto.modules[12], &allocator12, 12, 1, 1, 1);
	static switch_config_t config13 = { .position = 0 };

            static switch_state_t state13;
            static uint8_t memory13[SWITCH_STAGE_REQUIRED_MEMORY];
	...
	static dsp_thread_config_t config14 = {  };
            ...
            static uint8_t memory14[DSP_THREAD_STAGE_REQUIRED_MEMORY];
	...
	static reverb_room_config_t config16 = { .sampling_freq = 46000, .max_room_size = 1.5, .room_size = 1, .feedback = 1803886264, .damping = 858993458, .wet_gain = 1913946814, .dry_gain = 1913946814, .pregain = 32212254 };

            static reverb_room_state_t state16;
            static uint8_t memory16[REVERB_ROOM_STAGE_REQUIRED_MEMORY(46000,1.5)];
            ...
            adsp_auto.modules[16].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[16].control.module_type = e_dsp_stage_reverb_room;
                adsp_auto.modules[16].control.num_control_commands = NUM_CMDS_REVERB_ROOM;
                reverb_room_init(&adsp_auto.modules[16], &allocator16, 16, 1, 1, 1);
	static switch_config_t config17 = { .position = 0 };

            static switch_state_t state17;
            static uint8_t memory17[SWITCH_STAGE_REQUIRED_MEMORY];
	...
	static dsp_thread_config_t config19 = {  };
            ...
            static uint8_t memory19[DSP_THREAD_STAGE_REQUIRED_MEMORY];
            ...
            static uint8_t memory20[FORK_STAGE_REQUIRED_MEMORY];
	...
	static compressor_sidechain_config_t config23 = { .attack_alpha = 9336885, .release_alpha = 186738, .threshold = 13422, .slope = 0.4 };

            static compressor_sidechain_state_t state23;
            static uint8_t memory23[COMPRESSOR_SIDECHAIN_STAGE_REQUIRED_MEMORY(2)];
	...
	static switch_config_t config24 = { .position = 0 };
            ...
            static uint8_t memory24[SWITCH_STAGE_REQUIRED_MEMORY];
            ...
            static uint8_t memory25[ADDER_STAGE_REQUIRED_MEMORY];
            ...
            static uint8_t memory26[ADDER_STAGE_REQUIRED_MEMORY];
	...
	static dsp_thread_config_t config27 = {  };
            ...
            static uint8_t memory27[DSP_THREAD_STAGE_REQUIRED_MEMORY];
            ...
            static uint8_t memory28[FORK_STAGE_REQUIRED_MEMORY];
            ...
            static uint8_t memory29[FORK_STAGE_REQUIRED_MEMORY];
	...
	static switch_config_t config30 = { .position = 0 };
            ...
            static uint8_t memory30[SWITCH_STAGE_REQUIRED_MEMORY];
	...
	static switch_config_t config31 = { .position = 0 };
            ...
            static uint8_t memory31[SWITCH_STAGE_REQUIRED_MEMORY];
	...
	static volume_control_config_t config32 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };
            ...
            static uint8_t memory32[VOLUME_CONTROL_STAGE_REQUIRED_MEMORY(2)];
	...
	static volume_control_config_t config33 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };
            ...
            static uint8_t memory33[VOLUME_CONTROL_STAGE_REQUIRED_MEMORY(2)];
            ...
            static uint8_t memory34[FORK_STAGE_REQUIRED_MEMORY];
            ...
            static uint8_t memory36[FORK_STAGE_REQUIRED_MEMORY];
	...
	static envelope_detector_rms_config_t config35 = { .attack_alpha = 1867377, .release_alpha = 622459 };

            static envelope_detector_rms_state_t state35;
            static uint8_t memory35[ENVELOPE_DETECTOR_RMS_STAGE_REQUIRED_MEMORY(1)];
	...
	static mixer_config_t config37 = { .gain = 67268212 };

            static mixer_state_t state37;
            static uint8_t memory37[MIXER_STAGE_REQUIRED_MEMORY];
