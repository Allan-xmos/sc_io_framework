...
void dsp_auto_thread0(chanend_t* c_source, chanend_t* c_dest, module_instance_t** modules) {
	...
	int32_t* stage_11_output[] = {edge15, edge16};
	int32_t* stage_12_input[] = {edge16};
	int32_t* stage_12_output[] = {edge17};
	int32_t* stage_13_input[] = {edge15, edge17};
	int32_t* stage_13_output[] = {edge20};
	...
	SELECT_RES(
		...
		noise_suppressor_control(modules[12]->state, &modules[12]->control);
		switch_control(modules[13]->state, &modules[13]->control);
		control_done = true;
...
adsp_pipeline_t * adsp_auto_pipeline_init() {
	...
	static module_instance_t adsp_auto_modules[38];
	...
	adsp_auto.n_modules = 38;
	static pipeline_config_t config0 = { .checksum = {191, 249, 148, 77, 75, 228, 151, 184, 216, 214, 131, 40, 217, 235, 28, 164} };
	...
	static volume_control_config_t config5 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };
            ...
            static uint8_t memory7[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 3, 1))];
	...
	static switch_config_t config10 = { .position = 0 };
            ...
            static uint8_t memory10[_ADSP_MAX(1, SWITCH_REQUIRED_MEMORY(2, 1, 1))];
            ...
            static uint8_t memory11[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 2, 1))];
            ...
            adsp_auto.modules[11].control.config_rw_state = config_none_pending;
                ...
                fork_init(&adsp_auto.modules[11], &allocator11, 11, 1, 2, 1);
	static noise_suppressor_config_t config12 = { .attack_alpha = 17895697, .release_alpha = 745654, .threshold = 2386766, .slope = -2.0 };

            static noise_suppressor_state_t state12;
            static uint8_t memory12[_ADSP_MAX(1, NOISE_SUPPRESSOR_REQUIRED_MEMORY(1, 1, 1))];
            ...
            adsp_auto.modules[12].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[12].control.module_type = e_dsp_stage_noise_suppressor;
                adsp_auto.modules[12].control.num_control_commands = NUM_CMDS_NOISE_SUPPRESSOR;
                noise_suppressor_init(&adsp_auto.modules[12], &allocator12, 12, 1, 1, 1);
	static switch_config_t config13 = { .position = 0 };

            static switch_state_t state13;
            static uint8_t memory13[_ADSP_MAX(1, SWITCH_REQUIRED_MEMORY(2, 1, 1))];
            ...
            adsp_auto.modules[13].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[13].control.module_type = e_dsp_stage_switch;
                adsp_auto.modules[13].control.num_control_commands = NUM_CMDS_SWITCH;
                switch_init(&adsp_auto.modules[13], &allocator13, 13, 2, 1, 1);
	static dsp_thread_config_t config14 = {  };

            static dsp_thread_state_t state14;
            static uint8_t memory14[_ADSP_MAX(1, DSP_THREAD_REQUIRED_MEMORY(0, 0, 1))];
            ...
            adsp_auto.modules[14].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[14].control.module_type = e_dsp_stage_dsp_thread;
                adsp_auto.modules[14].control.num_control_commands = NUM_CMDS_DSP_THREAD;
                dsp_thread_init(&adsp_auto.modules[14], &allocator14, 14, 0, 0, 1);
            ...
            static uint8_t memory15[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 2, 1))];
            ...
            adsp_auto.modules[15].control.config_rw_state = config_none_pending;
                ...
                fork_init(&adsp_auto.modules[15], &allocator15, 15, 1, 2, 1);
	static reverb_config_t config16 = { .sampling_freq = 48000, .max_room_size = 1.5, .room_size = 1, .decay = 0.5, .damping = 0.4, .wet_gain = 1913946752, .dry_gain = 1913946752, .pregain = 0.015 };

            static reverb_state_t state16;
            static uint8_t memory16[_ADSP_MAX(1, REVERB_REQUIRED_MEMORY(1, 1, 1))];
            ...
            adsp_auto.modules[16].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[16].control.module_type = e_dsp_stage_reverb;
                adsp_auto.modules[16].control.num_control_commands = NUM_CMDS_REVERB;
                reverb_init(&adsp_auto.modules[16], &allocator16, 16, 1, 1, 1);
	static switch_config_t config17 = { .position = 0 };
	...
	static dsp_thread_config_t config19 = {  };

            static dsp_thread_state_t state19;
            static uint8_t memory19[_ADSP_MAX(1, DSP_THREAD_REQUIRED_MEMORY(0, 0, 1))];
            ...
            adsp_auto.modules[19].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[19].control.module_type = e_dsp_stage_dsp_thread;
                adsp_auto.modules[19].control.num_control_commands = NUM_CMDS_DSP_THREAD;
                dsp_thread_init(&adsp_auto.modules[19], &allocator19, 19, 0, 0, 1);

            static fork_state_t state20;
            static uint8_t memory20[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 6, 1))];
            ...
            adsp_auto.modules[20].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[20].control.config = NULL;
                adsp_auto.modules[20].control.num_control_commands = 0;
                fork_init(&adsp_auto.modules[20], &allocator20, 20, 1, 6, 1);
	static compressor_sidechain_config_t config21 = { .attack_alpha = 8947849, .release_alpha = 178957, .threshold = 13421, .slope = 0.4 };
	...
	static compressor_sidechain_config_t config23 = { .attack_alpha = 8947849, .release_alpha = 178957, .threshold = 13421, .slope = 0.4 };

            static compressor_sidechain_state_t state23;
            static uint8_t memory23[_ADSP_MAX(1, COMPRESSOR_SIDECHAIN_REQUIRED_MEMORY(2, 1, 1))];
            ...
            adsp_auto.modules[23].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[23].control.module_type = e_dsp_stage_compressor_sidechain;
                adsp_auto.modules[23].control.num_control_commands = NUM_CMDS_COMPRESSOR_SIDECHAIN;
                compressor_sidechain_init(&adsp_auto.modules[23], &allocator23, 23, 2, 1, 1);
	...
	static switch_config_t config24 = { .position = 0 };

            static switch_state_t state24;
            static uint8_t memory24[_ADSP_MAX(1, SWITCH_REQUIRED_MEMORY(2, 1, 1))];
            ...
            adsp_auto.modules[24].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[24].control.module_type = e_dsp_stage_switch;
                adsp_auto.modules[24].control.num_control_commands = NUM_CMDS_SWITCH;
                switch_init(&adsp_auto.modules[24], &allocator24, 24, 2, 1, 1);
            ...
            static adder_state_t state26;
            static uint8_t memory26[_ADSP_MAX(1, ADDER_REQUIRED_MEMORY(2, 1, 1))];
            ...
            adsp_auto.modules[26].control.config_rw_state = config_none_pending;
                ...
                adder_init(&adsp_auto.modules[26], &allocator26, 26, 2, 1, 1);
	static dsp_thread_config_t config27 = {  };

            static dsp_thread_state_t state27;
            static uint8_t memory27[_ADSP_MAX(1, DSP_THREAD_REQUIRED_MEMORY(0, 0, 1))];
            ...
            adsp_auto.modules[27].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[27].control.module_type = e_dsp_stage_dsp_thread;
                adsp_auto.modules[27].control.num_control_commands = NUM_CMDS_DSP_THREAD;
                dsp_thread_init(&adsp_auto.modules[27], &allocator27, 27, 0, 0, 1);
	...
	static switch_config_t config31 = { .position = 0 };

            static switch_state_t state31;
            static uint8_t memory31[_ADSP_MAX(1, SWITCH_REQUIRED_MEMORY(2, 1, 1))];
            ...
            adsp_auto.modules[31].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[31].control.module_type = e_dsp_stage_switch;
                adsp_auto.modules[31].control.num_control_commands = NUM_CMDS_SWITCH;
                switch_init(&adsp_auto.modules[31], &allocator31, 31, 2, 1, 1);
	...
	static volume_control_config_t config33 = { .target_gain = 134217728, .slew_shift = 7, .mute = 0 };

            static volume_control_state_t state33;
            static uint8_t memory33[_ADSP_MAX(1, VOLUME_CONTROL_REQUIRED_MEMORY(2, 2, 1))];
            ...
            adsp_auto.modules[33].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[33].control.module_type = e_dsp_stage_volume_control;
                adsp_auto.modules[33].control.num_control_commands = NUM_CMDS_VOLUME_CONTROL;
                volume_control_init(&adsp_auto.modules[33], &allocator33, 33, 2, 2, 1);

            static fork_state_t state34;
            static uint8_t memory34[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(1, 2, 1))];
            ...
            adsp_auto.modules[34].control.config_rw_state = config_none_pending;
                ...
                fork_init(&adsp_auto.modules[34], &allocator34, 34, 1, 2, 1);

            static fork_state_t state36;
            static uint8_t memory36[_ADSP_MAX(1, FORK_REQUIRED_MEMORY(2, 4, 1))];
            ...
            adsp_auto.modules[36].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[36].control.config = NULL;
                adsp_auto.modules[36].control.num_control_commands = 0;
                fork_init(&adsp_auto.modules[36], &allocator36, 36, 2, 4, 1);
	static envelope_detector_rms_config_t config35 = { .attack_alpha = 1789570, .release_alpha = 596523 };

            static envelope_detector_rms_state_t state35;
            static uint8_t memory35[_ADSP_MAX(1, ENVELOPE_DETECTOR_RMS_REQUIRED_MEMORY(1, 0, 1))];
            ...
            adsp_auto.modules[35].control.config_rw_state = config_none_pending;
                ...
                adsp_auto.modules[35].control.module_type = e_dsp_stage_envelope_detector_rms;
                adsp_auto.modules[35].control.num_control_commands = NUM_CMDS_ENVELOPE_DETECTOR_RMS;
                envelope_detector_rms_init(&adsp_auto.modules[35], &allocator35, 35, 1, 0, 1);
	static mixer_config_t config37 = { .gain = 67268211 };

            static mixer_state_t state37;
            static uint8_t memory37[_ADSP_MAX(1, MIXER_REQUIRED_MEMORY(2, 1, 1))];
            static adsp_bump_allocator_t allocator37 = ADSP_BUMP_ALLOCATOR_INITIALISER(memory37);

            adsp_auto.modules[37].state = (void*)&state37;

            // Control stuff
            adsp_auto.modules[37].control.id = 37;
            adsp_auto.modules[37].control.config_rw_state = config_none_pending;
            
                adsp_auto.modules[37].control.config = (void*)&config37;
                adsp_auto.modules[37].control.module_type = e_dsp_stage_mixer;
                adsp_auto.modules[37].control.num_control_commands = NUM_CMDS_MIXER;
                mixer_init(&adsp_auto.modules[37], &allocator37, 37, 2, 1, 1);
	return &adsp_auto;
}
